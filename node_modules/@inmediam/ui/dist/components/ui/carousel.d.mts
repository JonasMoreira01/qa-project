...
interface CarouselDotsProps extends React.ButtonHTMLAttributes<HTMLDivElement>, VariantProps<typeof dotsVariants> {
}
declare const CarouselDots: React.ForwardRefExoticComponent<CarouselDotsProps & React.RefAttributes<HTMLDivElement>>;

export { Carousel, type CarouselApi, CarouselContent, CarouselDots, type CarouselDotsProps, CarouselItem, CarouselNext, CarouselPrevious, type CarouselProps };
